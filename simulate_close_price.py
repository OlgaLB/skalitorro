...
print('Historic March data: ' + str(historic_march_data))
...
print('Historic April data: ' + str(historic_april_data))
...
for index, row in historic_april_data.iterrows():
    ...
    print('Predicted April Price: ' + str(predicted_price))
    print('Real April Price: ' + str(row[['Close']]))
